        ...
        <div class="audition-wrapper">
            ...
            <div class="audition-content">
                <div className="audition-left">
                    ...
                    <p>For Fall 2026: Auditions will be August 17-19. Please use the following form to select an audition time.</p>
                    <a href="https://zcal.co/clemsonchoirs/auditions" target="_blank"><BigButton label="Audition Form"/></a>
                    <p>If you would like to be a part of the Men's Choir (MUSC 3720) or Women’s Choir (MUSC 3710), no audition is necessary. Simply register for the class on iRoar. For more information on Tigeroar and TakeNote auditions contact <a href="mailto:clemsonchoirs@gmail.com">clemsonchoirs@gmail.com.</a></p>
                </div>
